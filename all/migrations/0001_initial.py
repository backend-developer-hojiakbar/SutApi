    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dealer', models.ForeignKey(blank=True, limit_choices_to={'user_type__ne': 'admin'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dealer_requests', to=settings.AUTH_USER_MODEL)),
                ('shop', models.ForeignKey(limit_choices_to={'user_type__ne': 'admin'}, on_delete=django.db.models.deletion.CASCADE, related_name='shop_requests', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Mahsulot',
